...
<head>
    ...
    <title>Cadastrar - Sistema WEB</title>
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="POST">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputNome" type="text" placeholder="Nome" name="usuario" required>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-12">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="inputQuantidade" type="password" placeholder="Quantidade" name="senha" required>
                                                    <label for="inputQuantidade">senha</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <a class="btn btn-success" href="loginForm.php">Voltar</a>
                                ...
                                <?php
                                    ...
                                    if (isset($_POST["usuario"]) && isset($_POST["senha"])){
                                        ...
                                        echo'
                                            <script>
                                                window.location.replace("http://localhost/trabalho_ROKA/login/loginForm.php");
                                            </script>';
